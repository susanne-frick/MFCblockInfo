...
# res <- foreach (d=1:1792, .combine=rbind, .verbose=T, .packages=c("mvtnorm","numDeriv","devtools","lpSolveAPI","MFCblockInfo"),
...
d <- 1792
                  ...
                  saveRDS(res.r, file=paste0("results_opt_int-variance/results_opt_int-variance_d",d,".rds"))
                  res.r
                # }

# saveRDS(res, file="results_opt_int-variance.rds")
