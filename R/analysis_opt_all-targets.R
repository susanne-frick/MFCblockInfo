...
print(xtable::xtable(var.paper, digits=0,
                     caption="Variance in optimization targets explained in \\% by algorithm, target, intercepts and block size in simulation study 2 on test construction",
                     label="tb:var_sim_opt"), include.colnames = F, include.rownames=T, hline.after=c(0, nrow(var.paper)-1),
...
print(xtable::xtable(means.paper, digits=2,
                     caption="Mean trait recovery by condition in simulation study 2 on automated test assembly",
